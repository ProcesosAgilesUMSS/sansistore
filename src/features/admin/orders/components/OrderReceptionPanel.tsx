  ...
  return (
    <section className="space-y-5">
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-[var(--theme-border)] bg-white p-5">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-black/45">
            Entregados
          </p>
          <p className="mt-2 text-3xl font-black text-black">{orders.length}</p>
        </div>
        <div className="rounded-2xl border border-[var(--theme-border)] bg-white p-5">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-black/45">
            Validados
          </p>
          <p className="mt-2 text-3xl font-black text-[#88b04b]">
            {confirmedCount}
          </p>
        </div>
        <div className="rounded-2xl border border-[var(--theme-border)] bg-white p-5">
          ...
          <p className="mt-2 text-3xl font-black text-black/70">
      ...
      <div className="rounded-2xl border border-[var(--theme-border)] bg-white p-5">
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          ...
          <PackageCheck className="text-[#88b04b]" size={24} />
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-dashed border-black/15 px-5 py-10 text-center text-sm text-black/50">
          ...
          <div className="overflow-hidden rounded-xl border border-black/10">
            {orders.map((order) => (
              <article
                key={order.id}
                className="grid gap-3 border-b border-black/10 p-4 last:border-b-0 md:grid-cols-[minmax(0,1fr)_auto_auto] md:items-center"
              >
                ...
                <div className="flex items-center gap-2 rounded-full border border-black/10 px-3 py-2 text-xs font-bold">
                  {order.confirmed ? (
                    <>
                      <CheckCircle size={15} className="text-[#88b04b]" />
                ...
                <p className="text-sm font-black text-[#88b04b]">
