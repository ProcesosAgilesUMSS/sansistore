  ...
  return (
    ...
    >
      <div
        ...
        className="bg-(--theme-card-bg) border border-(--theme-border) text-(--theme-text) max-w-2xl w-full px-6 py-6 rounded-2xl flex flex-col max-h-[90vh] overflow-y-auto relative shadow-2xl"
      >
