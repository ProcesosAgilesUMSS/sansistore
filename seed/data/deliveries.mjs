...
export const Deliveries = {
  ...
  // Entregas ya completadas: Nadia queda sin entrega activa (accepted/in_transit)
  // para poder aceptar un pedido asignado en los smoke tests del mensajero.
  DELIVERY_008: {
    code: 'delivery-008',
    orderCode: 'order-008',
    courier: Users.NADIA,
